...
//           headers: { Authorization: `Bearer ${token}` },
//         });
//         setTickets(response.data.tickets || []); // Fallback to empty array
//       } catch (error) {
//         if (error.response && error.response.status === 401) {
//           dispatch({ type: "LOGOUT" });
//           navigate("/login");
...
//     try {
//       const response = await axios.put(
//         `${BACKENDURL}/api/v1/tickets/cancel/${uid}`,
//         {},
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
...
//   // Filter tickets based on activeTab
//   const filteredTickets = tickets.filter((ticket) => {
//     if (!ticket) return false; // Skip invalid entries
...
//           </div>
//         ) : (
//           <p className="mt-5 text-gray-500">No tickets found for this category.</p>
//         )}
//       </div>
//     </div>
//   );
