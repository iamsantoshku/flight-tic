...
//   return (
//     <div className="relative w-full max-w-[1300px] mx-auto mt-[20vw] sm:mt-[20vw] overflow-hidden">
//       <div
...
const Planesliding = () => {
  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto mt-[110vw] lg:mt-[17vw] sm:mt-45 overflow-hidden">
      <div
