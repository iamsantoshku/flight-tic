...
const Hero = () => {
  ...
  return (
    <section className="back w-[158vw] sm:w-[100vw] relative bg-cover bg-center h-[115vh] sm:h-[97vh] -ml-12" style={{ backgroundImage: `url(${img1})` }}>
      <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent opacity-80"></div>
      ...
      {/* Search */}
      <div className="relative z-20  bg-white shadow-lg rounded-lg p-5 mb-20 max-w-7xl mx-auto flex flex-col items-center justify-center transform -translate-y-1/3 sm:w-[100vw]">

        <div className="flex gap-3 mb-4 justify-start sm:-ml-[65vw]">
          <button
            className={`py-2 px-4 rounded-lg font-semibold ${tripType === 'oneWay' ? 'bg-yellow-300 text-black' : 'bg-gray-200 text-gray-700'}`}
            onClick={() => handleTripTypeChange('oneWay')}
          >
        ...
        <button
          className="mt-8 bg-yellow-300 hover:bg-yellow-600 text-black font-semibold py-3 px-10 rounded-lg sm:ml-[68vw]"
          onClick={navToSearchPage}
        >
          Search Flights
        </button>
