      ...
      <div className="bg-white bg-opacity-90 p-7 rounded-lg shadow-lg w-[85vw]">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 flex-wrap">
          ...
          <div className="flex flex-col lg:flex-row gap-4 flex-wrap items-center w-full">
            {/* From Input */}
            <div className="flex flex-col p-5 border-[1px] border-gray-300 rounded-lg w-full lg:w-auto">
            ...
            {/* <div>
              <button
                className="hover:bg-[#1E293B] bg-[#bebebe] text-black hover:text-white px-5 py-2 mt-2 lg:mt-0 rounded-xl transition duration-100 h-[3.5vw] w-[11vw]"
                onClick={handleFlightSearch}
              >
                Search Flights
              </button>
            ...
            <div>
  <button
    className="hover:bg-[#1E293B] bg-[#bebebe] text-black hover:text-white px-5 py-6 mt-2 lg:mt-0 rounded-full transition duration-100 
               text-sm md:text-base lg:text-lg 
               h-auto  w-full sm:w-[250px] md:w-[250px] lg:w-[180px]"
    onClick={handleFlightSearch}
  >
    Search Flights
  </button>
