...
const SearchComponent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg p-10 bg-gray-50 w-[86vw] max-w-8xl mx-auto -mt-20 ">
      {/* Trip Type Selection */}

      <div className="flex mb-4 space-x-4 -ml-[70vw] relative z-10">
        <button
