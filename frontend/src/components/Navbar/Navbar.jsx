...
//             <li className="relative group">
//               <NavLink className="flex items-center hover:text-orange-500" to="/">
//                 Home
//                 <FaAngleDown className="ml-1" />
//               </NavLink>
...
//             </li>
//             <li className="relative group">
//               <NavLink className="flex items-center hover:text-orange-500" to="/search">
//                 Tickets
//                 <FaAngleDown className="ml-1" />
//               </NavLink>
...
//             </li>
//             <li className="relative group">
//               <NavLink className="flex items-center hover:text-orange-500" to="/blog-grid">
//                 Blog
//                 <FaAngleDown className="ml-1" />
//               </NavLink>
